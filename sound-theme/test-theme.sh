...
for i in /home/jesusda/Público/github/the-perfect-desktop/sound-theme/pasodoble/*.wav
do

echo "$(tput setaf 1)PROBANDO ARCHIVO: $i $(tput setaf 7)"
/usr/bin/canberra-gtk-play -f $i | grep Fail
